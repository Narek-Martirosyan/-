            ...
            <div className="container my-container">
                ...
                <div className='social-media text-center pb-5'>
                    <IconButton sx={{ cursor: 'none!important', '&:active': { backgroundColor: '#9b9b9b' } }}>
                        <a style={{ cursor: 'none', display: 'inherit' }} href="https://www.facebook.com/narek.martirosyan.399" target={'_blank'}>
                            <FacebookRoundedIcon sx={{ cursor: 'none', color: 'white', '&:hover': { color: 'rgb(138, 137, 137)' }, '&:active': { color: 'blue' } }} />
                        </a>
                    </IconButton>

                    <IconButton sx={{ cursor: 'none!important', '&:active': { backgroundColor: '#9b9b9b' } }}>
                        <a style={{ cursor: 'none', display: 'inherit' }} href="https://twitter.com/narek______" target={'_blank'}>
                            <TwitterIcon sx={{ cursor: 'none', color: 'white', '&:hover': { color: 'rgb(138, 137, 137)' }, '&:active': { color: 'blue' } }} />
                        </a>
                    </IconButton>

                    <IconButton sx={{ cursor: 'none!important', '&:active': { backgroundColor: '#9b9b9b' } }}>
                        <a style={{ cursor: 'none', display: 'inherit' }} href="https://www.linkedin.com/in/narek-martirosyan-journalist/" target={'_blank'}>
                            <LinkedInIcon sx={{ cursor: 'none', color: 'white', '&:hover': { color: 'rgb(138, 137, 137)' }, '&:active': { color: 'blue' } }} />
                        </a>
                    </IconButton>

                    <IconButton sx={{ cursor: 'none!important', '&:active': { backgroundColor: '#9b9b9b' } }}>
                        <a style={{ cursor: 'none', display: 'inherit' }} href="https://www.bzbzik.com/" target={'_blank'}>
